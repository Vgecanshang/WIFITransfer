...
public class WebService extends Service{
    ...
    private static final String APK_CONTENT_TYPE = "application/vnd.android.package-archive";//APK站点下载格式
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d("WebService" , "WebService onStartCommand");
        if (intent != null) {
    ...
    private void startServer() {
        ...
        Log.d("WebService" , "WebService startServer");
