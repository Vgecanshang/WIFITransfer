...
STRINGS.WIFI_TRANS_TITLE = 'WiFi Transfer';
...
STRINGS.UNSUPPORTED_FILE_TYPE = '请选择EPUB、TXT或PDF或apk、jpg、png文件。';
...
STRINGS.SUPPORTED_FILE_TYPES = '支持apk、jpg、png、EPUB、TXT和PDF';
